...
export default function FormHeader() {
  ...
  return (
   <Card className="p-4 border-t-4 border-t-primary mb-4 shadow-sm">
  {logoUrl && (
    <div className="mb-4">
      <img
        src={logoUrl}
    ...
    <div className="flex gap-2 flex-wrap">
      {steps.map((s) => (
        <div
          ...
          ${currentStep === s ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"}`}
        >
      ...
      {/* Add Step */}
      <button
        className="h-6 w-6 flex items-center justify-center rounded-full border border-dashed text-muted-foreground hover:text-primary hover:border-primary/60"
        onClick={() => {
