...
const GridItem = ({
    ...
    const hasLeftBorder = col !== 2; 
    const hasTopBorder = true;  

    const borderClasses = `
        ${hasLeftBorder ? "border-r border-border" : ""}
    ...
    return (
        <div
            onClick={onClick}
            className={`
                group relative p-8 md:p-12 bg-white dark:bg-neutral-900
        ...
        >
            ...
            <h3 className="text-xl md:text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-3 md:mb-4 tracking-tight transition-colors duration-300">
                {title}
            </h3>

            <p className="text-neutral-500 dark:text-neutral-400 leading-relaxed text-sm md:text-base font-medium transition-colors duration-300">
                {description}
            </p>
